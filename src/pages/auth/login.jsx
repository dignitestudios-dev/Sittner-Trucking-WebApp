        ...
        <div className='grid grid-cols-1 xl:grid-cols-2 p-3  h-screen  lg:py-10 lg:px-10  lg:gap-4  flex items-center ' >
            ...
            <div className=''>
                <div className='flex items-center flex-col ' >
                    ...
                    <h2 className='mb-3 font-bold text-[32px] leading-[38px]' >Welcome Back</h2>
                    <p className='mb-3 font-medium text-base leading-[19px]' >Please enter the details below to continue</p>
                </div>
                <form className="max-w-sm mx-auto mt-3" onSubmit={(e) => Login(e)} >
                    ...
                    <div className="relative mb-2">
                        ...
                        <div className="absolute inset-y-0 end-0 flex items-center pe-3.5 ">
                            {
                                showPassword ? (
                                    <div onClick={() => setShowPassword(!showPassword)} ><FaRegEye className='text-gray-400 cursor-pointer' /></div>
                                ) : (
                                    <div onClick={() => setShowPassword(!showPassword)}> <FaEyeSlash className='text-gray-400 cursor-pointer' /></div>
                                )
                            }
                    ...
                    <div className='mb-2 mt-2 text-end'>
                        <NavLink to={'/forgotpassword'} className={'font-medium text-xs'} >Forgot Password</NavLink>
                    </div>
                    <div>
                        <button type="submit" className="text-white bg-[#0A8A33]  rounded-lg  w-full  px-5 py-2.5 text-center">Login</button>
                    </div>
                </form>
