  ...
  return (
    <div class="bg-[#F7F7F7] h-[90vh] px-3 py-3 lg:py-10 lg:px-10 ">
      ...
      <div className="bg-[#FFFFFF] border rounded-[10px] border-[#E4E4E4] mt-10 py-3 px-3 h-[90%] lg:py-6 lg:px-6 overflow-auto scroll-box">
        ...
        <h3 className="text-2xl leading-[29px] font-semibold mt-5 text-[#222222]">
        ...
        <ul className="px-10 list-disc">
          ...
          <li>
            ...
            mentions “Company,” “we,” “us,” or “our,” it refers to JB Sittner
            Trucking LLC, (49600 CR 29.5 Nunn, Co, 80648), that is responsible
            for your information under this Privacy Policy
          </li>
          <li>
            <span className="font-bold"> Country </span>: where JB Sittner
            Trucking or the owners/founders of JB Sittner Trucking are based, in
            this case is United States of America
          </li>
          <li>
            <span className="font-bold"> Customer </span>: refers to the
            company, organization or person that signs up to use the JB Sittner
            Trucking Service to manage the relationships with your consumers or
            service users.
          </li>
          <li>
            ...
            can be used to visit JB Sittner Trucking and use the services.
            users.
          </li>
          <li>
            ...
            location from which a device is connecting to the Internet. users.
          </li>
          <li>
            <span className="font-bold">Personnel </span>: refers to those
            individuals who are employed by JB Sittner Trucking or are under
          ...
          <li>
            ...
            provided by JB Sittner Trucking as described in the relative terms
          ...
          <li>
            <span className="font-bold">Website </span>: JB Sittner Trucking’s
          ...
          <li>
            ...
            registered with JB Sittner Trucking to use the Services.
          </li>
        </ul>
        ...
        <p className="mt-4 mb-3">
          ...
          practicable. If you are an end user and wish to update, delete, or
          receive any information we have about you, you may do so by contacting
        ...
        <p className="mt-4 mb-3">
          ...
          responsible for any ThirdParty Services, including their accuracy,
        ...
        <p className="mt-4 mb-3">CalOPPA users have the following rights:</p>
        <ul className="list-disc px-10">
          <li>
            Right to Know and Access. You may submit a verifiable request for
            information regarding the: (1) categories of Personal Information we
        ...
        <ul className="list-disc px-10">
          <li>
            Via Email:
            <a href={"mailto:office@jbsittner.com"}>office@jbsittner.com</a>
          </li>
          <li>
            Via Phone Number:<a href={"tel:9708972640"}>9708972640</a>{" "}
          </li>
          <li>
            Via this Link:
            <a href={"https://www.jbsittnertruckingllc.com/"}>
              https://www.jbsittnertruckingllc.com/{" "}
            </a>
          </li>
