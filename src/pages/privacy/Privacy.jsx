...
export default function Privacy() {
  return (
    ...
    <>
      ...
      <h1
        className="font-semibold text-[24px] leading-[29px] py-2"
        style={{
      ...
      <br />
        <p>
          {" "}
          JB Sittner Trucking (“we,” “our,” or “us”) is committed to protecting
          your privacy. This Privacy Policy explains how your personal
          information is collected, used, and disclosed by JB Sittner Trucking.
        </p>
        <br />
        <p>
          This Privacy Policy applies to our website, and its associated
          subdomains (collectively, our “Service”) alongside our application, JB
          Sittner Trucking. By accessing or using our Service, you signify that
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >Definitions and key terms</h2>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            80648), that is responsible for your information under this Privacy
            Policy.
          </li>
          <li>
            Country: where JB Sittner Trucking or the owners/founders of JB
            Sittner Trucking are based, in this case is United States of America
          </li>
          <li>
            Customer: refers to the company, organization or person that signs
            up to use the JB Sittner Trucking Service to manage the
          ...
          <li>
            Personnel: refers to those individuals who are employed by JB
            Sittner Trucking or are under contract to perform a service on
          ...
          <li>
            Website: JB Sittner Trucking’s site, which can be accessed via this
            URL: https://www.jbsittnertruckingllc.com/
          </li>
          <li>
            You: a person or entity that is registered with JB Sittner Trucking
            to use the Services.
          </li>
        </ul>
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >What Information Do We Collect?</h2>
        <p>
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >
          When does JB Sittner Trucking use end user information from third
          parties?
        </h2>
        <p>
          JB Sittner Trucking will collect End User Data necessary to provide
          the JB Sittner Trucking services to our customers. End users may
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >
          When does JB Sittner Trucking use customer information from third
          parties?
        </h2>
        <p>
          ...
          interest in becoming a JB Sittner Trucking customer, we receive
          information from a third party that provides automated fraud detection
          services to JB Sittner Trucking. We also occasionally collect
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >Do we share the information we collect with third parties?</h2>
        <p>
        ...
        <p>
          JB Sittner Trucking will collect personal information that you submit
          to us. We may also receive personal information about you from third
          parties as described above.
        </p>
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >How Do We Use The Information We Collect?</h2>
        <p>
        ...
        <p />
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >How Do We Use Your Email Address?</h2>
        <p>
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >How Long Do We Keep Your Information?</h2>
        <p>
          We keep your information only so long as we need it to provide JB
          Sittner Trucking to you and fulfill the purposes described in this
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >How Do We Protect Your Information?</h2>
        <p>
          ...
          absolute security of any information you transmit to JB Sittner
          Trucking or guarantee that your information on the Service may not be
          accessed, disclosed, altered, or destroyed by a breach of any of our
          physical, technical, or managerial safeguards.
        </p>
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >Could my information be transferred to other countries?</h2>
        <p>
          JB Sittner Trucking is incorporated in United States of America.
          Information collected via our website, through direct interactions
          with you, or from use of our help services may be transferred from
          ...
          you voluntarily consent to the trans-border transfer and hosting of
          such information.
        </p>
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >
          Is the information collected through the JB Sittner Trucking Service
          secure?
        </h2>
        <p>
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >Can I update or correct my information?</h2>
        <p>
          The rights you have to request updates or corrections to the
          information JB Sittner Trucking collects depend on your relationship
          with JB Sittner Trucking. Personnel may update or correct their
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >Personnel</h2>
        <p>
          If you are a JB Sittner Trucking worker or applicant, we collect
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >Sale of Business</h2>
        <p>
          ...
          of the assets of JB Sittner Trucking or any of its Corporate
          Affiliates (as defined herein), or that portion of JB Sittner Trucking
          or any of its Corporate Affiliates to which the Service relates, or in
          the event that we discontinue our business or file a petition or have
          filed against us a petition in bankruptcy, reorganization or similar
          proceeding, provided that the third party agrees to adhere to the
          terms of this Privacy Policy.
        </p>
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >Affiliates</h2>
        <p>
          ...
          JB Sittner Trucking, whether by ownership or otherwise. Any
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >Governing Law</h2>
        <p>
          This Privacy Policy is governed by the laws of United States of
          America without regard to its conflict of laws provision. You consent
          to the exclusive jurisdiction of the courts in connection with any
          action or dispute arising between the parties under or in connection
          with this Privacy Policy except for those individuals who may have
          rights to make claims under Privacy Shield, or the Swiss-US framework.
        </p>
        <br />
        <p>
        ...
        <br />
        <p>
          By using JB Sittner Trucking or contacting us directly, you signify
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >Your Consent</h2>
        <p>
          ...
          it's being used. By using our JB Sittner Trucking, registering an
          account, or making a purchase, you hereby consent to our Privacy
          Policy and agree to its terms.
        </p>
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >Links to Other Websites</h2>
        <p>
          This Privacy Policy applies only to the Services. The Services may
          contain links to other websites not operated or controlled by JB
          Sittner Trucking. We are not responsible for the content, accuracy or
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >Cookies</h2>
        <p>
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >Blocking and disabling cookies and similar technologies</h2>
        <p>
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >Kids' Privacy</h2>
        <p>
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >Changes To Our Privacy Policy</h2>
        <p>
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >Third-Party Services</h2>
        <p>
        ...
        <p>
          ...
          decency, quality or any other aspect thereof. JB Sittner Trucking does
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >Tracking Technologies</h2>
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >Information about General Data Protection Regulation (GDPR)</h2>
        <p>
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >What is GDPR?</h2>
        <p>
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >What is personal data?</h2>
        <p>
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >Why is GDPR important?</h2>
        <p>
          ...
          right thing to do. At JB Sittner Trucking we strongly believe that
        ...
        <p>
          ...
          requirements of GDPR. JB Sittner Trucking processes or stores all
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >California Residents</h2>
        <p>
        ...
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >California Online Privacy Protection Act (CalOPPA)</h2>
        <p>
        ...
        <p>For more information about these rights, please contact us.</p>
        <br />
        <h2  className="font-semibold text-[24px] leading-[29px] py-2" >Contact Us</h2>
