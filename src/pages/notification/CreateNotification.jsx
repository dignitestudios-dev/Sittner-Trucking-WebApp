...
export default function CreateNotification() {
    ...
    return (
        <div class='bg-[#F7F7F7] h-[80vh] py-5 px-5 ' >
            <NavLink to={'/notification'} className='font-semibold text-[24px] leading-[29px] flex items-center' > <IoMdArrowBack size={25} className='mr-2' /> Create Notification</NavLink>
            ...
            <div class='bg-[#FFFFFF] mb-3 h-full border rounded-[10px] border-[#E4E4E4] mt-6 px-3 py-3 lg:py-5 lg:px-10' >
                <form>
                    ...
                    <div className='flex items-center gap-5 mt-5' >
                        <button onClick={()=>navigate("/notification")} type="submit" className="text-white bg-[#0A8A33]  rounded-lg  w-[150px] h-[50px]  px-5 py-2.5 text-center">Save</button>
