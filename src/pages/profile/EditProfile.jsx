                ...
                <form>
                    ...
                    <div class='mt-5 grid grid-cols-1 gap-5  lg:grid-cols-2' >
                        ...
                        <div >
                            ...
                            <input type="email" id="base-input" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg  h-[60px] mt-1 block w-full p-2.5 focus:outline-[#0A8A33]  " required  placeholder='Contact No' />
                        </div>
                        <div >
