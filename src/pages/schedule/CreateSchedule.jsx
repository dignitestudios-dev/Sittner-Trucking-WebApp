            ...
            <div class='bg-[#FFFFFF] mb-3 h-[70%] border rounded-[10px] border-[#E4E4E4] mt-6 px-3 lg:py-5 lg:px-10' >
                <form onSubmit={(e)=>e.preventDefault()} >
                    ...
                    <div className='flex items-center gap-5 mt-5' >
                        <button onClick={()=>navigate("/schedule")} type="submit" className="text-white bg-[#0A8A33]  rounded-lg  w-[150px] h-[50px]  px-5 py-2.5 text-center">Schedule</button>
                        <NavLink to={'/schedule'} className="bg-[#F1F1F1] font-bold rounded-lg  w-[150px] h-[50px]  px-5 py-2.5 text-center">Cancel</NavLink>
                    </div>
                </form>
