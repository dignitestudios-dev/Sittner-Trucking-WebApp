            ...
            <div class='bg-[#FFFFFF] border rounded-[10px] border-[#E4E4E4] mt-6 lg:py-10 lg:px-10' >
                <div class='bg-[#F9FAFB] rounded-[10px] border border-[#E4E4E4] py-3 px-3 lg:py-10 lg:px-10'>
                    <div className='flex items-center' >
                        ...
                        <div className='flex items-center' >
                            <div className='bg-[#94D0E4] flex rounded-[50%] items-center justify-center  w-[58px] h-[58px]' >
                                <img src="/large-person-3.png" class='cursor-pointer w-[58px] h-[58px]' alt="" />
                            </div>

                        </div>
                        <label htmlFor="changeprofile" className='ml-3 font-semibold text-base underline cursor-pointer'>  Change Photo</label>
                        <input type="file" className='hidden' id='changeprofile' />
                    </div>
                    <form>
                        <div className='mt-5 grid grid-cols-1 gap-5 lg:grid-cols-2'>
                            <div className='mb-3'>
                                <label className='text-[13px] mb-1 font-semibold leading-[16.94px]'>Name</label>
                                <input
                                    type="text"
                                    id="name-input"
                            ...
                            <div className='mb-3'>
                                <label className='text-[13px] mb-1 font-semibold leading-[16.94px]'>Email</label>
                                <input
                                    type="email"
                                    id="email-input"
                            ...
                            <div className='mb-3'>
                                <label className='text-[13px] mb-1 font-semibold leading-[16.94px]'>Address</label>
                                <input
                                    type="text"
                                    id="address-input"
                                    className="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg h-[60px] mt-1 block w-full p-2.5 focus:outline-[#0A8A33]"
                            ...
                            {token === "admin" && (
                                <div className='mb-3'>
                                    <label className='text-[13px] mb-1 font-semibold leading-[16.94px]'>Password</label>
                                    <input
                                        type="password"
                                        id="password-input"
                                        className="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg h-[60px] mt-1 block w-full p-2.5 focus:outline-[#0A8A33]"
                    ...
                    <div className='flex items-center gap-5'>
                        <button
                            onClick={() => {
                                token === "admin" ? navigate("/employee") : navigate("/profile");
                            }}
                            type="submit"
                        ...
                        <NavLink to={'/'} className="bg-[#F1F1F1] font-bold rounded-lg w-[150px] h-[50px] px-5 py-2.5 text-center">
                            Cancel
                        </NavLink>
                    </div>
