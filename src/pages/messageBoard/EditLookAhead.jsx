...
export default function EditLookAhead() {
  ...
  return (
    ...
    <NavLink to={'/'} className='font-semibold text-[24px] leading-[29px] flex items-center' > <IoMdArrowBack size={25} className='mr-2' /> Edit Message</NavLink>
    ...
    <div class='bg-[#FFFFFF] h-[100%] border rounded-[10px] border-[#E4E4E4] mt-6 lg:py-5 lg:px-5' >
            ...
            <form>
                <div className='mt-5 grid grid-cols-1 gap-5  lg:grid-cols-2' >
                    ...
                    <button type="submit" onClick={()=>navigate("/")} className="text-white bg-[#0A8A33]  rounded-lg  w-[150px] h-[50px]  px-5 py-2.5 text-center">Save</button>
                    <NavLink to={'/'} className="bg-[#F1F1F1] font-bold rounded-lg  w-[150px] h-[50px]  px-5 py-2.5 text-center">Cancel</NavLink>
                    </div>
            </form>
