                        ...
                        <div className="relative w-[350px]  my-6 mx-auto max-w-4xl">
                            ...
                            <div className="border-0  rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                <div className="relative p-6  flex flex-col items-center">
                                    ...
                                    <h3 className="font-semibold text-[20px] leading-[29px] mb-3 capitalize" >Delete Employee</h3>
                                    <p className="text-[#565656] text-[13px] text-center font-medium leading-[20px] " >Are you sure you want to  <br/> delete this employee?</p>
