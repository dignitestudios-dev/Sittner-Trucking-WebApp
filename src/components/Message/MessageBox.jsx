...
export default function MessageBox() {
  ...
  return (
    <div className='bg-[#FFFFFF] w-full h-[550px] relative rounded-[24px]' >
      ...
      {/* Message Body */}
      <div className="chat-body h-[340px] scroll-box  overflow-auto">
        {/* Day Timer */}
      ...
      <form className="w-100 bg-white lg:px-5 py-5 flex items-center absolute bottom-0 w-full  justify-center gap-8 ">
        ...
        <div>
          <button
            type="button"
            className="text-white bg-[#0A8A33] hover:bg-green-800 focus:ring-4  rounded-full text-sm p-2.5 text-center flex items-center  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
