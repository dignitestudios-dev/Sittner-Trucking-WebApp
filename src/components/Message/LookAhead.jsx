             ...
             {token=="admin"&&<NavLink to={"/createlook"} className={`flex text-sm w-[203px] font-semibold text-center bg-[#0A8A33] text-white h-[44px] flex items-center justify-center rounded-[8px] font-semibold mt-3 px-4 mx-5 py-2 `}> <FaPlus className='mr-2 text-sm'  /> Create New Message</NavLink>}
                <div className="look-ahead   px-3 py-5 w-[100%]" >
                    <div className="username mb-3 flex items-center justify-between">
                        ...
                        {token=="admin"&& <NavLink to={'/editlook'} className='bg-transparent' ><img src="/whiteedit.png" className='w-5' alt="" srcset="" /></NavLink>}
                    </div>
                    <div className='w-full py-2 px-2 bg-[#F9F9F9] border border-[#DFDFDF] rounded-[10px]' >
                        ...
                        <div className=' w-full rounded-2xl mt-2 text-xs font-normal' >Lorem ipsum dolor sit amet consectetur. Tellus ornare viverra arcu at gravida sed. </div>
                        <span className='text-[12px] font-normal text-[#5C5C5C]' >20-08-2024</span>
