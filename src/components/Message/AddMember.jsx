                    ...
                    >
                        <div className="relative h-[400px]  w-[350px]  my-6 mx-auto max-w-4xl">
                            ...
                            <div className="flex justify-between" >
                                <div>
                                    <h2 className="text-[18px] font-semibold leading-[21px]" >Members</h2>
                                </div>
                                <div>
                                <IoMdClose className="cursor-pointer" onClick={()=>setIsAddMem(false)} size={20} />
                                </div>
                            </div>
                                {/*body*/}
                            ...
                            <ul className="px-2">
                            {
                                    user.map((item, i) => (
                                        <li className="mt-3 flex justify-between items-center">
                                            ...
                                            <div>
                                                <button className={` ${item.status=="pending"?"bg-[#0A8A33] text-white":"bg-[#0A8A331A] text-[#0A8A33]"}   rounded-lg  w-[96px] h-[32px]   text-[13px] font-normal text-nowrap text-center`}>{item.status=="pending"?"Add Member":"Added"}</button>
                                            </div>
                                        </li>
                                    ))
                                }               
