...
export default function Attachment() {
    ...
    const {LookScreen,setLookScreen,viewAll,setIsViewAll}=useContext(MyContext);
        ...
        <div>
            ...
            >
                ...
                >
                    ...
                    <div
                        id="accordion-1"
                        className={`transition-all duration-200 ${!openIndex == 1 ? "" : "hidden"
                            }`}
                    >
                        <div className="py-1 rounded-md mt-1 ">
                            <ul className="max-w-md  dark:divide-gray-700">
                               ...
                               <button onClick={()=>setIsViewAll(true)} className='bg-transparent text-[13px] font-medium text-[#007AFF] space-x-4 mt-3 underline'>View all</button>
