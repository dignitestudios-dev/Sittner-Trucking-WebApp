                    ...
                    >
                        <div className="relative h-[450px]  w-[350px]  my-6 mx-auto max-w-4xl">
                            ...
                            <div className="flex justify-between" >
                                <div>
                                    <h2 className="text-[18px] font-semibold leading-[21px]" >Message Info</h2>
                                </div>
                                <div>
                                <IoMdClose className="cursor-pointer" onClick={()=>setIsMessageInfo(false)} size={20} />
                                </div>
                            </div>
                                {/*body*/}
                                        ...
                                        <li className="mt-3">
                                            <div className="flex items-center space-x-2 rtl:space-x-reverse">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <p className="text-[#ABABAB] text-[12px]" >{item.seen}</p>
                                                </div>
                                            </div>                                            
                                        </li>
                                    ))
