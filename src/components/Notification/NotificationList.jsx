                    ...
                    <tbody >
                        <tr className="bg-white  border-b-2 border-[#F4F4F4]  ">
                            ...
                            <td className="px-6 py-10">
                                <div className="bg-[#FF99001F] w-[100px] text-center text-[#FF9900] text-xs font-bold me-2 px-4 py-2 rounded-full  ">Scheduled</div>
                            </td>
                            <td className="px-6 py-10">
                                <NavLink to={'/editnotification'} className='bg-transparent'><img src="/whiteedit.png" className='w-5 lg:w-5' alt="" srcset="" /></NavLink>
                            </td>
                        </tr>
                        <tr className="bg-white border-b-2 border-[#F4F4F4]">
                            <th
                            ...
                            <td className="px-6 py-10">
                                <div className="bg-[#41C54E26] w-[100px] text-center text-[#41C54E] text-xs font-bold me-2 px-4 py-2 rounded-full  ">Delivered</div>
                            </td>
                            <td className="px-6 py-10">
                                <button to={'/editnotification'} className='bg-transparent'><img src="/whiteedit.png" className='w-5 lg:w-5' alt="" srcset="" /></button>
                            </td>
                        </tr>
