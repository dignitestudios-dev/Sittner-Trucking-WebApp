...
export default function DatePicker() {
    ...
    const getDayCount = (date) => {
        ...
        let blankdaysArray = Array.from({ length: dayOfWeek === 0 ? 6 : dayOfWeek - 1 }, (_, i) => i + 1);
    ...
    return (
                                ...
                                {type === "date" && (
                                    ...
                                    >
                                        <div className="text-center">
                                            {format(datepickerHeaderDate, "MMMM")}  {format(datepickerHeaderDate, "yyyy")}
                            ...
                            {type === "date" && (
                                <>
                                    ...
                                    <div className="flex flex-wrap -mx-1">
                                        ...
                                        {dayCount.map((d, i) => (
                                            <div key={i} style={{ width: "14.26%" }} className="px-1 mb-2">
                                                <div
        ...
        ${getDay(new Date(datepickerHeaderDate.getFullYear(), datepickerHeaderDate.getMonth(), d)) === 0 ? "text-red-500" : ""}
      `}
                                                >
                                                    {d}
                                                </div>
